<template>
  <div>
    <br />
    <br />
    <div class=" centro">Preguntas Empreasa</div>
      ...
      <v-layout row wrap>
        <v-flex xs12 sm12>
          <v-card color="blue darken-4">
            ...
            <v-data-table :headers="headers" :items="preguntasReconocimiento" :search="search" class="elevation-1">
              <template v-slot:items="props">
                <td class="text-xs-center">{{ props.item.NO_EMPRESA }}</td>
...
export default {
  created() {
    this.getPreguntasReconocimiento();
