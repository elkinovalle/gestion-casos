<template>
  <div>
    <br>
    <br>
    <v-subheader class="subheader black--text display-1 font-weight-bold centro">Preguntas</v-subheader>
    <v-form ref="form">
      <v-container>
        <v-layout row wrap>
          <v-flex xs12 sm6>
            <v-text-field v-model="editedItem.nombre" box label="Id" clearable></v-text-field>
          </v-flex>

          <v-flex xs12 sm6>
            <v-text-field v-model="editedItem.precio" box label="Tema" type="number" clearable></v-text-field>
          </v-flex>

          <v-flex xs12 sm6>
            <v-textarea v-model="editedItem.descripcion" box label="Pregunta" clearable></v-textarea>
          </v-flex>

          <v-flex xs12 sm6>
            <v-textarea v-model="editedItem.beneficio" box label="Respuesta A" clearable></v-textarea>
          </v-flex>
