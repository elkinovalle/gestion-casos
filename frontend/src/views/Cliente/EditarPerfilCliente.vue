    ...
    <v-container fluid>
      <v-layout row>
        ...
        <v-flex xs3 order-lg2>
          ...
          <v-flex   xs2 order-lg2 class="transparent text-xs-center">
            <br>
             <v-card-text><strong>Numero de Documento :</strong></v-card-text>
        </v-flex>
         <v-flex xs3 order-lg2>
       ...
       <v-layout  row>
        ...
        <v-flex xs3 order-lg2>
          ...
          <v-flex   xs2 order-lg2 class="transparent text-xs-center">
            <br>
             <v-card-text><strong>Telefono :</strong></v-card-text>
        </v-flex>
        <v-flex xs3 order-lg2>
      ...
      <v-layout  row>
        <v-flex   xs2 order-lg2 class="transparent text-xs-center">
          <br>
             <v-card-text><strong>Perfil:</strong></v-card-text>
             <br>
        </v-flex>
        <v-flex xs3 order-lg2>
          <v-combobox
...
export default {
  ...
  methods: {
    ...
    async submit () {
      ...
      const { data: user } = await api.put(`/user/${this.uuid}`,
        {
          userUpdate: {
            nombre: this.nombre,
